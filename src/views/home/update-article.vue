...
import type { IUpdateArticleForm } from "@/types/article";
import type { FormItemProps } from "naive-ui";
import { useForm } from "vee-validate";
import { updateArticleZod } from "./rules";
...
const { defineField, handleSubmit, resetForm, setValues } = useForm<IUpdateArticleForm>({
  validationSchema: updateArticleZod,
  initialValues: {
    title: "",
    content: "",
    author: "",
...
watchEffect(() => {
  if (props.visible && props.currentRow) {
